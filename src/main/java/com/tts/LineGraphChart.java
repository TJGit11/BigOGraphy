...
public class LineGraphChart extends ApplicationFrame {
    ...
    public LineGraphChart(String title){
        ...
        final XYDataset dataset1 = createRandomDataset("0(1)", readCoordinates(FileNameConstants.CONSTANT_TIME));
        ...
        this.plot.setDataset(1, createRandomDataset("0(n)", readCoordinates(FileNameConstants.LINEAR_TIME)));
        this.plot.setRenderer(1, new StandardXYItemRenderer());
        this.plot.setDataset(2, createRandomDataset("0(logn)", readCoordinates(FileNameConstants.LOG_TIME)));
        this.plot.setRenderer(2, new StandardXYItemRenderer());
        this.plot.setDataset(3, createRandomDataset("0(n^2)", readCoordinates(FileNameConstants.POLY_TIME)));
